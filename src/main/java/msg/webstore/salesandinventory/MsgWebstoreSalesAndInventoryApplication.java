...
public class MsgWebstoreSalesAndInventoryApplication {

    public final static String MESSAGE_QUEUE = "example-queue";
    ...
    public static void main(String[] args) {
        SpringApplication.run(MsgWebstoreSalesAndInventoryApplication.class, args);
    }
